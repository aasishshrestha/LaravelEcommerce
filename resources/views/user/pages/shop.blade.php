...
@push('title')
    <title>Shop-One stop solution for purchasing bicycle</title>
@endpush
                                ...
                                @foreach ($products as $product)
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img" style="height:325px; width:300px;object-fit:cover;">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>{{ $product->title }}</h4>
                                                <p><a href="{{ route('show.product', $product->id) }}">View More</a></p>
